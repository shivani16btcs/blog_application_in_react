...
{ (toggle_addform===true)?
    <div className="addNoteForm">
        ...
        {/* <textarea class="field_content" id="comment" class="form-control" value={field["content"]} onChange={handleChange} type="textarea" name="comments" id="comments" placeholder="Your Comment"  rows="10"></textarea> */}
        ...
        <br></br>
        <button className="NOTE_save create_blog1" type="submit">Save</button>
        <button className="NOTE_cancel create_blog1" onClick={Togglefun} >Cancel</button>
        </form>   
    </div>
    :
    <div>
    <button className="NOTE noteform create_blog1" onClick={Togglefun} type="submit"> Add Your Blog</button>
